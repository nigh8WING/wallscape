...
- **Core Functionality**:
  ...
  - **One-Click Native Debian Packaging (.deb)**: Integrated CPack Debian generator (`wallscape-2.4-Linux.deb`) for double-click installation via Zorin OS App Center.
...
│  │   v2.4                  │     - Root Folders View (Folder Cards)      │  │
...
#### Versioning Standard (`1.1 ➜ 1.9 ➜ 2.0 ➜ 2.4`):
- **Incremental Decimal Progression**: Versions progress sequentially: `1.1` ➜ `1.9` ➜ `2.0` ➜ `2.4` ➜ `2.9` ➜ `3.0`.
