...
/* Custom CSS Stylesheet — Modern Fluent / Mica Dark Theme */
static const char *STUDIO_CSS =
"* {"
"    font-family: 'Segoe UI Variable Display', 'Segoe UI Variable Text', 'Segoe UI', -apple-system, BlinkMacSystemFont, 'Inter', system-ui, sans-serif;"
"}"
...
"    background-color: rgba(91, 140, 255, 0.30);"
"    border-color: #5b8cff;"
"    color: #ffffff;"
"}"
...
"}"
".update-btn:hover {"
"    background-color: rgba(53, 132, 228, 0.30);"
"    border-color: #58a6ff;"
"    color: #ffffff;"
"}"
...
GuiCtx *gui_create(AppState *state, WallpaperCtx *wallpaper)
{
    ...
    /* Force Dark Theme Mode across all platforms */
...
#ifdef _WIN32
    GtkWidget *brand_sub = gtk_label_new("for Windows 11");
#else
